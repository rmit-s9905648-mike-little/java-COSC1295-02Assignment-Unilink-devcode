...
public class reply_job extends Reply
{
	 ///////////////////////////////////////////////////////////////////////////
	 //Define Class Attributes from here
	//=========================================================================
	//private double reply_job_value=0.00;
	// this has  been zeroed out as this is not needed for replying to an job.
	...
	public reply_job
			(
			String reply_job_post_id,
			double reply_job_value,
			String reply_job_responder_id	
			)
...
} // close class reply_job extends Reply
